        ...
        <div style={{ background: "var(--soft)", borderRadius: 12, padding: "14px 16px", marginBottom: 14 }}>
          ...
          {cv?.availability && (
            <div className="cand-cv-section">
              ...
              <div>
                <span className="cand-cv-tag" style={{ background: "color-mix(in srgb,var(--red) 10%,transparent)", color: "var(--red)", borderColor: "color-mix(in srgb,var(--red) 18%,transparent)" }}>
                  ✓ {cv.availability}
                </span>
              </div>
            </div>
