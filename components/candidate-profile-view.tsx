        ...
        <div className="panel">
          ...
          {cv?.availability && (
            <div style={{ marginBottom: 18 }}>
              ...
              <span style={{ background: "color-mix(in srgb,var(--red) 10%,transparent)", color: "var(--red)", border: "1px solid color-mix(in srgb,var(--red) 18%,transparent)", borderRadius: 8, padding: "5px 12px", fontSize: 13, fontWeight: 600 }}>
                ✓ {cv.availability}
              </span>
            </div>
          )}
