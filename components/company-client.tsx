...
const JOB_STATUS_CONFIG = {
  active:         { color: "#e5232a", bg: "rgba(229,35,42,.10)", emoji: "●" },
    ...
    <div className="app-shell">
      ...
      <main className="app-main">
        ...
        {!company ? (
          ...
          <div className="notice-card" style={{ background: "color-mix(in srgb,var(--red) 6%,var(--paper))", border: "2px solid color-mix(in srgb,var(--red) 18%,var(--line))", marginBottom: 12 }}>
